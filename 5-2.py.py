...
while True : 
    ...
    #print(userEntered)
    #print(type(userEntered))
    
    if userEntered == 'done' :
        break
    elif maximum is None or testMax > maximum : 
        maximum = testMax
    elif minimum is None or testMin < minimum : 
        minimum = testMin
    print('Largest so far:', maximum, ' Smallest so far: ', minimum)
